      ...
      <div className="modal-content">
        ...
        <form onSubmit={handleSubmit} className="formulario">
          <div className="campo">
            ...
            <input type="text" id="nombre" name="nombre" required maxLength="100" placeholder="Ej. Alex Mercer" />
          </div>

          <div className="campo">
            <label htmlFor="gamertag">Gamertag o Alias *</label>
            <input type="text" id="gamertag" name="gamertag" required maxLength="50" placeholder="Ej. Shadow" />
          </div>

          <div className="campo">
            <label htmlFor="correo">Correo Electrónico *</label>
            <input type="email" id="correo" name="correo" required maxLength="150" placeholder="alex@ejemplo.com" />
          </div>
